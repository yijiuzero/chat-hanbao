...
// Attach window.hanbao.chat (Chat customization), extend
// window.hanbao.host with hooks + fetch, attach window.hanbao.audit.
installHostSdk();
...
// the registry so `window.hanbao.modules.<page>` is populated soon after
