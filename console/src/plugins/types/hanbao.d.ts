/**
 * plugins/types/hanbao.d.ts — stable public contract for plugin authors.
 *
 * Plugin TS projects (cloudpaw, hanbao-pet, …) should COPY this file into
 * their own `hanbao-host.d.ts` and uncomment the `declare global` block at
 ...
 *
 * Inside the host, the global `Window.Hanbao` is declared in
...
export interface HanbaoHostNamespace {
...
export interface HanbaoWindowNamespace {
  host: HanbaoHostNamespace;
...
// Plugin projects: uncomment this in your own hanbao-host.d.ts to type
// `window.hanbao.*` accesses in plugin code.
//
// declare global {
//   interface Window {
//     Hanbao: HanbaoWindowNamespace;
//   }
// }
