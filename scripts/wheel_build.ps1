...
$ConsoleDest = Join-Path $RepoRoot "src\hanbao\console"
...
Write-Host "[wheel_build] Copying console/dist/* -> src/hanbao/console/..."
...
$DocsDest = Join-Path $RepoRoot "src\hanbao\docs"
