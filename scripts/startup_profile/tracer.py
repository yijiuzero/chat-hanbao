#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Function execution tracer for Hanbao."""
import json
import time
import traceback
...
class ExecTracer:
    """Trace function execution in hanbao package."""
...
def main():
    """Run tracer on hanbao app import."""
    ...
    tracer = ExecTracer(package_names=["hanbao"])
    sys.settrace(tracer.trace_calls)

    try:
        # Import hanbao app to trigger startup
        from hanbao.app._app import (  # pylint: disable=unused-import
            app,
        )  # noqa: F401
    finally:
        sys.settrace(None)
