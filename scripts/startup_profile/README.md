...
One-click analysis of Hanbao startup performance, identify bottlenecks, and provide optimization suggestions.
...
- **Import Time Analysis** - Hanbao modules and third-party library import time ranking
...
2. **Data Analysis**
   - Parse log files
   - Categorize statistics (Hanbao/third-party/stdlib)
...
- Python 3.8+
- No extra dependencies (except Hanbao itself)
- Pure JSON data output
- HTML runs standalone, viewable offline

## Related Tools

- `src/hanbao/utils/startup_display.py` - Startup banner display
