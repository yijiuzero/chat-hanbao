...
logger = logging.getLogger("hanbao").getChild("plugin.cloudpaw")
...
def _ensure_default_env_vars() -> None:
    """Ensure required env var keys always appear in the Hanbao console.
    ...
    """
    try:
        from hanbao.envs import load_envs, save_envs
    except ImportError:
        logger.warning("Cannot import hanbao.envs; env provisioning skipped")
        return
