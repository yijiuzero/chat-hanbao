...
from hanbao.cli.tui.widgets.messages import (
    WelcomeMessage,
    _bounce,
    _bright_dot_hex,
    _relative_luminance,
...
def test_welcome_message_shows_workspace_and_project_dirs():
    welcome = WelcomeMessage(
        _PALETTE,
        workspace_dir="/tmp/hanbao/workspaces/default",
...
def test_logo_splits_into_one_segment_per_glyph():
    ...
    "Hanbao" is seven glyphs (the paw prints ride on the second "a"), so the
