...
from hanbao.cli.tui.widgets.status_bar import (
    _CTX_AMBER,
    _CTX_GREEN,
    _CTX_RED,
    StatusBar,
...
def test_version_renders_in_status_bar():
    bar = StatusBar()
    bar.set(hanbao_version="1.1.10")
    summary = bar.summary
    assert "Hanbao 1.1.10" in summary
    # Only Hanbao's version is shown; the TUI version was removed.
