# -*- coding: utf-8 -*-
"""Tests for hanbao.agents.utils.file_handling.
...
from hanbao.agents.utils.file_handling import (
    _default_download_dir,
    _guess_suffix_from_file_content,
    _resolve_local_path,
    download_file_from_base64,
...
class TestDefaultDownloadDir:
    ...
    @patch("hanbao.agents.utils.file_handling.get_current_workspace_dir")
...
class TestDownloadFileFromUrl:
    ...
    @pytest.mark.asyncio
    @patch(
        "hanbao.agents.utils.file_handling._download_remote_to_path",
    )
