# -*- coding: utf-8 -*-
"""Tests for hanbao.agents.utils.audio_transcription.
...
from hanbao.agents.utils.audio_transcription import (
    _get_configured_provider_creds,
    _get_manager,
    _url_for_provider,
    check_local_whisper_available,
...
_MOD = "hanbao.agents.utils.audio_transcription"
...
class TestGetManager:
    ...
    def test_returns_instance(self):
        ...
        with patch(
            "hanbao.providers.provider_manager.ProviderManager.get_instance",
    ...
    def test_import_failure_returns_none(self):
        with patch.dict(
            "sys.modules",
            {"hanbao.providers.provider_manager": None},
        ):
            _get_manager()
