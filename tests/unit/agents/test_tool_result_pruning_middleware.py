...
from hanbao.agents.middlewares import (  # noqa: E402
    ToolResultPruningMiddleware,
)
from hanbao.agents.tools.utils import (  # noqa: E402
...
from hanbao.config.config import (  # noqa: E402
    LightContextConfig,
    ScrollContextConfig,
    ToolResultPruningConfig,
)
from hanbao.constant import TRUNCATION_NOTICE_MARKER  # noqa: E402
from hanbao.runtime.builder import AgentBuilder  # noqa: E402
from hanbao.agents.react_agent import HanbaoAgent  # noqa: E402
from hanbao.tool_calls import (  # noqa: E402
    ToolCoordinator,
...
async def test_tool_response_write_failure_fails_open(
    ...
    monkeypatch.setattr(
        "hanbao.agents.tools.utils.save_text_output",
        fail_save,
    )
...
def test_explicit_legacy_scroll_tool_cap_warns_once_and_is_not_saved(
    ...
    import hanbao.config.config as config_module

    monkeypatch.setattr(config_module, "_legacy_scroll_tool_cap_warned", False)
    with caplog.at_level(logging.WARNING, logger="hanbao.config.config"):
