...
flag AND the deployment-layer ``HANBAO_ALLOW_UNSANDBOXED_RECALL`` env var, so
...
from hanbao.agents.context import scroll_unsandboxed_allowed

_ENV = "HANBAO_ALLOW_UNSANDBOXED_RECALL"
