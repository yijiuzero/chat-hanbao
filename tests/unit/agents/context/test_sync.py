...
from hanbao.agents.context.scroll import sync as sync_mod
from hanbao.agents.context.scroll.sync import (
    MANIFEST_NAME,
...
def _stub_config_loaders(monkeypatch, workspace: Path) -> None:
    ...
    import hanbao.config as cfg
    import hanbao.config.config as cfgcfg
