...
def yuanbao_channel(mock_process, tmp_path):
    ...
    from hanbao.app.channels.yuanbao.channel import YuanbaoChannel
...
def sample_upload_result():
    ...
    from hanbao.app.channels.yuanbao.media import UploadResult
...
class TestMediaHelpers:
    ...
    def test_guess_mime_jpeg(self):
        from hanbao.app.channels.yuanbao.media import _guess_mime
    ...
    def test_parse_image_size_png(self):
        from hanbao.app.channels.yuanbao.media import _parse_image_size
    ...
    def test_resolve_local_path_file_uri(self):
        from hanbao.app.channels.yuanbao.media import _resolve_local_path
...
class TestMediaMsgBody:
    ...
    def test_build_image_msg_body(self, sample_upload_result):
        from hanbao.app.channels.yuanbao.media import build_image_msg_body
    ...
    def test_build_file_msg_body(self):
        from hanbao.app.channels.yuanbao.media import (
            UploadResult,
            build_file_msg_body,
        )
...
class TestCosSignature:
    ...
    def test_sign_cos_request_format(self):
        from hanbao.app.channels.yuanbao.media import _sign_cos_request
...
class TestAuthSignature:
    ...
    def test_compute_signature(self):
        from hanbao.app.channels.yuanbao.auth import _compute_signature
...
class TestTokenManager:
    ...
    async def test_token_manager_init(self):
        from hanbao.app.channels.yuanbao.auth import TokenManager
    ...
    async def test_get_auth_headers(self):
        from hanbao.app.channels.yuanbao.auth import (
            SignTokenResult,
            TokenCache,
            TokenManager,
        )
...
class TestSendText:
    ...
    async def test_send_text_calls_ws(self, connected_channel):
        ...
        with patch(
            "hanbao.app.channels.yuanbao.channel.build_send_c2c_msg",
        ) as mock_build:
...
class TestSendMedia:
    ...
    async def test_send_media_part_upload_success(self, connected_channel):
        ...
        with patch(
            "hanbao.app.channels.yuanbao.channel.download_and_upload_media",
...
class TestCodecHelpers:
    ...
    def test_to_proto_msg_body_text(self):
        from hanbao.app.channels.yuanbao.codec import _to_proto_msg_body
    ...
    def test_from_proto_msg_body(self):
        from hanbao.app.channels.yuanbao.codec import _from_proto_msg_body
...
class TestHelperFunctions:
    ...
    def test_short_id_long_string(self):
        from hanbao.app.channels.yuanbao.channel import _short_id
    ...
    def test_sender_display_normal(self):
        from hanbao.app.channels.yuanbao.channel import _sender_display
...
class TestParseMsgBody:
    ...
    async def test_parse_image_elem(self, connected_channel, tmp_path):
        ...
        with patch(
            "hanbao.app.channels.yuanbao.channel.download_media",
...
class TestResolveExtension:
    ...
    def test_filename_suffix_takes_priority_over_octet_stream(self):
        from hanbao.app.channels.yuanbao.utils import _resolve_extension
...
class TestBuildSafeFilename:
    ...
    def test_preserves_cjk_when_no_conflict(self, tmp_path):
        from hanbao.app.channels.yuanbao.utils import _build_safe_filename
