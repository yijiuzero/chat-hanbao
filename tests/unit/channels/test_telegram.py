...
def test_telegram_base_urls_derive_api_and_file_prefixes():
    ...
    from hanbao.app.channels.telegram.channel import _telegram_base_urls
...
def telegram_channel(
    ...
    from hanbao.app.channels.telegram.channel import TelegramChannel
...
class TestTelegramSendMediaValue:
    ...
    async def test_send_media_value_file_not_found(
        ...
        from hanbao.app.channels.telegram.channel import (
...
class TestTelegramMessageMeta:
    ...
    def test_message_meta_full(self):
        ...
        from hanbao.app.channels.telegram.channel import _message_meta
...
class TestTelegramExceptions:
    ...
    def test_file_too_large_error(self):
        ...
        from hanbao.app.channels.telegram.channel import _FileTooLargeError
...
class TestTelegramPollingReconnect:
    ...
    async def test_teardown_swallows_errors_and_settles(
        ...
        with patch(
            "hanbao.app.channels.telegram.channel.asyncio.sleep",
            new=AsyncMock(),
        ) as mock_sleep:
