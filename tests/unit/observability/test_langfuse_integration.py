...
from hanbao.observability import langfuse as lf
...
class TestLangfuseTraceHook:
    ...
    async def test_skips_when_langfuse_disabled(self, monkeypatch):
        ...
        from hanbao.hooks.observability.langfuse_hook import LangfuseTraceHook
    ...
    async def test_opens_trace_scope_when_enabled(self, monkeypatch):
        ...
        from hanbao.hooks.observability.langfuse_hook import (
            LangfuseTraceHook,
            _LANGFUSE_SCOPE_KEY,
        )
        ...
        assert lf.get_current_trace().name == "hanbao.agent.react_loop"
...
class TestLangfuseToolSpanMiddleware:
    ...
    async def test_passthrough_when_no_active_trace(self, monkeypatch):
        ...
        from hanbao.agents.middlewares import LangfuseToolSpanMiddleware
