...
"""Tests for hanbao.security.tool_guard.engine."""
...
from hanbao.security.tool_guard.engine import (
    ToolGuardEngine,
    _guard_enabled,
    get_guard_engine,
)
...
def _reset_singleton():
    ...
    import hanbao.security.tool_guard.engine as eng_mod
...
class TestGuardEnabled:
    ...
    @patch("hanbao.security.tool_guard.engine.EnvVarLoader")
...
class TestGetGuardEngine:
    @patch(
        "hanbao.security.tool_guard.engine.ToolGuardEngine",
        autospec=True,
    )
