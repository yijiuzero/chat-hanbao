...
Target: src/hanbao/security/tool_guard/guardians/file_guardian.py
...
from hanbao.security.tool_guard.guardians.file_guardian import (
...
from hanbao.security.tool_guard.models import GuardFinding, GuardSeverity

# Short alias for the long module path used in patch() calls
_FG_MOD = "hanbao.security.tool_guard.guardians.file_guardian"
