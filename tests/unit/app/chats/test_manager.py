# -*- coding: utf-8 -*-
"""Unit tests for ``hanbao.app.chats.manager.ChatManager``.
...
from hanbao.app.chats.manager import ChatManager
from hanbao.app.chats.models import (
    ChatSpec,
    ChatUpdate,
    SessionSource,
)
from hanbao.app.chats.repo import (
    JsonChatRepository,
)
from hanbao.app.channels.schema import DEFAULT_CHANNEL
