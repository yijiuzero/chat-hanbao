...
class TestResolveClientIp:
    ...
    @patch("hanbao.app.auth._get_config_cached")
...
class TestShouldSkipAuthDefenseInDepth:
    ...
    @patch("hanbao.app.auth._get_config_cached")
    @patch("hanbao.app.auth.is_auth_enabled", return_value=True)
    @patch("hanbao.app.auth.has_registered_users", return_value=True)
    def test_loopback_direct_passes(self, _a, _b, mock_cfg):
        from hanbao.app.auth import AuthMiddleware  # noqa: F811
