# -*- coding: utf-8 -*-
"""Unit tests for ``hanbao.app.routers.messages``.
...
def app(manager_mock) -> FastAPI:
    ...
    from hanbao.app.routers.messages import router as messages_router
...
def test_send_message_returns_500_when_manager_not_in_state():
    ...
    from hanbao.app.routers.messages import router
