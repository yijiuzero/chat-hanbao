...
pytest.importorskip(
    "hanbao.app.mcp.manager",
    reason=(
        "hanbao.app.mcp.manager (MCPClientManager) was removed in "
        "AgentScope 2.0; MCP lifecycle is handled by the workspace layer"
    ),
)
from hanbao.app.mcp.manager import (  # type: ignore[import]
    MCPClientManager,
)
from hanbao.app.workspace.service_factories import (  # type: ignore[import]
    create_mcp_service,
)
from hanbao.app.workspace.workspace import Workspace
from hanbao.config.config import MCPClientConfig, MCPConfig
