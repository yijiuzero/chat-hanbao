...
Spawns a dedicated subprocess with HANBAO_AUTH_ENABLED=true and
...
def auth_app_server(  # pylint: disable=too-many-statements
    ...
    """Spawn a hanbao app subprocess with auth=true + seeded user."""
    ...
    env["HANBAO_AUTH_USERNAME"] = _AUTH_USERNAME
    env["HANBAO_AUTH_PASSWORD"] = _AUTH_PASSWORD
