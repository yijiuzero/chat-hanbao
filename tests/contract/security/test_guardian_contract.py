...
from hanbao.security.tool_guard.guardians import BaseToolGuardian
...
from hanbao.security.tool_guard.models import GuardFinding
...
def file_guardian():
    ...
    with patch(
        "hanbao.security.tool_guard.guardians.file_guardian"
