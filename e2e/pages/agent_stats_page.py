# -*- coding: utf-8 -*-
"""
Hanbao AgentStats agent statistics page object.
...
class AgentStatsPage(BasePage):
    ...
    # Date range picker
    DATE_RANGE_PICKER = ".hanbao-picker-range, .hanbao-picker"
    DATE_RANGE_INPUT = ".hanbao-picker-range input, .hanbao-picker input"
    DATE_PICKER_PANEL = ".hanbao-picker-panel, .hanbao-picker-dropdown"

    # Summary cards
    SUMMARY_CARD = '[class*="summaryCard"], [class*="SummaryCard"], .hanbao-card'
    SUMMARY_CARD_TITLE = '[class*="cardTitle"], [class*="title"], .hanbao-statistic-title'
    SUMMARY_CARD_VALUE = '[class*="cardValue"], [class*="value"], .hanbao-statistic-content-value'
    ...
    def get_card_title(self, card: Locator) -> str:
        ...
        title_el = card.locator(
            '[class*="title"], .hanbao-statistic-title, h3, h4, span'
        ).first
    ...
    def get_card_value(self, card: Locator) -> str:
        ...
        value_el = card.locator(
            '[class*="value"], .hanbao-statistic-content-value, '
