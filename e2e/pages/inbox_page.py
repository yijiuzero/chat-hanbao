...
class InboxPage(BasePage):
    ...
    TAB_PUSH = (
        '.hanbao-tabs-tab:has-text("Push Messages"), '
        '.hanbao-tabs-tab:has-text("推送消息")'
    )
    TAB_APPROVALS = (
        '.hanbao-tabs-tab:has-text("Approvals"), '
        '.hanbao-tabs-tab:has-text("审批")'
    )
    ...
    # rendered as <sup class="hanbao-badge-dot"> inside the menu title.
    # data-menu-id is auto-generated by rc-menu (e.g. "rc-menu-uuid-N-inbox"),
    # so we anchor on the bilingual menu label instead.
    SIDEBAR_INBOX_BADGE = (
        'li.hanbao-menu-item:has(span.hanbao-menu-title-content:has-text("Inbox")) '
        '.hanbao-badge-dot, '
        'li.hanbao-menu-item:has(span.hanbao-menu-title-content:has-text("收件箱")) '
        '.hanbao-badge-dot'
    )

    # Detail modal
    DETAIL_MODAL = '.hanbao-modal'
    ...
    POPCONFIRM_OK = (
        ...
        '.hanbao-popover button.hanbao-btn-primary'
    )
