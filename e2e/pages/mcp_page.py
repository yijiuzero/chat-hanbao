...
class McpPage(BasePage):
    ...
    CREATE_BTN_SELECTOR = 'button.hanbao-btn-primary:has-text("创建客户端")'
    ...
    # Create dialog
    MODAL_CONTENT_SELECTOR = '.hanbao-modal-content'
    MODAL_TITLE_SELECTOR = '.hanbao-spark-modal-title'
