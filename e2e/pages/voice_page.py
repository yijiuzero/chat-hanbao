...
class VoicePage(BasePage):
    ...
    # Page load indicator
    PAGE_LOAD_INDICATOR = '.hanbao-switch, .hanbao-switch-input, [class*=voiceToggle]'

    # Voice service switch
    VOICE_TOGGLE_SELECTOR = '.hanbao-switch, .hanbao-switch-input, [class*=voiceToggle]'

    # Configuration form
    CONFIG_FORM_SELECTOR = '.hanbao-form, [class*=configForm], form'

    # Success message
    SUCCESS_MESSAGE_SELECTOR = '.hanbao-message-success, .hanbao-notification-success'
