# -*- coding: utf-8 -*-
"""
Hanbao E2E test framework - Page Object base class.
...
class BasePage:
    ...
    SUCCESS_MESSAGE = '.ant-message-success, .hanbao-message-success, .hanbao-notification-success'
    ERROR_MESSAGE = '.ant-message-error, .hanbao-message-error, .hanbao-notification-error'
    LOADING_SPINNER = '.ant-spin, .hanbao-spin, [class*=loading]'
    ...
    def step_shot(self, action: str, full_page: bool = False) -> str:
        ...
        - The test case name is passed through page._hanbao_test_name (injected by conftest).
        ...
        try:
            ...
            test_name = getattr(self.page, "_hanbao_test_name", None) or "unknown_test"
            ...
            seq = getattr(self.page, "_hanbao_step_seq", 0) + 1
            try:
                self.page._hanbao_step_seq = seq
            except Exception:
                pass
