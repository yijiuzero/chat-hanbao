# -*- coding: utf-8 -*-
"""
Hanbao Plugin Manager page object.
...
class PluginPage(BasePage):
    ...
    TAB_INSTALLED = (
        '.hanbao-tabs-tab:has-text("Installed"), '
        '.hanbao-tabs-tab:has-text("已安装")'
    )
    TAB_OFFICIAL = (
        '.hanbao-tabs-tab:has-text("Official"), '
        '.hanbao-tabs-tab:has-text("官方")'
    )
