...
class SecurityPage(BasePage):
    ...
    # Tabs
    TOOL_GUARD_TAB = '[data-node-key="toolGuard"] .hanbao-tabs-tab-btn'
    FILE_GUARD_TAB = '[data-node-key="fileGuard"] .hanbao-tabs-tab-btn'

    # Active panel
    ACTIVE_PANEL = '.hanbao-tabs-tabpane-active'

    # Guard switch
    GUARD_SWITCH = 'button.hanbao-switch[role="switch"]'

    # Save button
    SAVE_BTN = 'button.hanbao-btn-primary:has-text("保存"), button:has-text("保 存")'

    # Protected tools select
    PROTECTED_TOOLS_SELECT = '.hanbao-select'
