...
class TestDebugPageDisplay:
    ...
    def test_debug_page_load_and_display(self, page: Page, request: pytest.FixtureRequest):
        ...
        info_alert = page.locator('.hanbao-alert-info, .hanbao-alert').first
        ...
        log_card = page.locator('.hanbao-card').first
        expect(log_card).to_be_visible(timeout=5000)
        card_title = log_card.locator('.hanbao-card-head-title').first
...
class TestDebugLogControls:
    ...
    def test_debug_log_control_buttons(self, page: Page, request: pytest.FixtureRequest):
        ...
        error_alert = page.locator('.hanbao-alert-error').first
        ...
        switches = page.locator('.hanbao-card-extra .hanbao-switch, .hanbao-card-head .hanbao-switch').all()
...
class TestDebugLogLevelFilter:
    ...
    def test_debug_log_level_filter(self, page: Page, request: pytest.FixtureRequest):
        ...
        level_select = page.locator('.hanbao-select').first
        ...
        for level in expected_levels:
            option = dropdown.locator(f'.hanbao-select-item:has-text("{level}")').first
        ...
        error_option = dropdown.locator(
            '.hanbao-select-item:has-text("ERROR"), '
            '.hanbao-select-item:has(.hanbao-tag)'
        ).first
        ...
        level_select.click()
        page.wait_for_timeout(500)
        all_option = page.locator('.hanbao-select-dropdown .hanbao-select-item').first
...
class TestDebugLogSearch:
    ...
    def test_debug_log_keyword_search(self, page: Page, request: pytest.FixtureRequest):
        ...
        clear_btn = search_input.locator('..').locator('.hanbao-input-clear-icon').first
...
class TestDebugLogFileInfo:
    ...
    def test_debug_log_file_info(self, page: Page, request: pytest.FixtureRequest):
        ...
        warning_alert = page.locator('.hanbao-alert-warning').first
