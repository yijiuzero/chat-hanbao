...
class ToolGovernanceSpec:
    ...
    ``hanbao.agents.tools`` (treated as a governance gap). Dynamic tools
...
_BUILTIN_TOOLS_PREFIX = "hanbao.agents.tools."
...
def tool_descriptor(
    ...
    **metadata: Any,
    ...
    Built-in tools (under ``hanbao.agents.tools``) are automatically
