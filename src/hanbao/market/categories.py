...
a native filter code (modelscope today, hanbao once its codes are known)
...
CATEGORIES: list[_Category] = [
    ...
    },
    {
        ...
        "hanbao": "engineering development",
