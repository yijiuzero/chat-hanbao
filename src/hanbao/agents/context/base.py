...
management. :class:`~hanbao.agents.react_agent.HanbaoAgent` delegates its two
...
class ContextManager(Protocol):
    ...
    async def compress(self, agent: Any, context_config: Any = None) -> None:
        ...
        Called from ``HanbaoAgent.compress_context`` in place of the native
    ...
    def on_save(self, agent: Any, blocks: Sequence[Any]) -> None:
        ...
        Called from ``HanbaoAgent._save_to_context`` after the base append,
