...
module name, without the rest of hanbao on the path.
...
# Values must match SYNTHETIC_USER_MESSAGE_TAGS in hanbao.constant (this
...
class MemorySpace:
    ...
    def _raw_saved_tool_refs(
        ...
        if isinstance(parsed, dict):
            by_block = parsed.get("hanbao_truncation")
