...
Example:
    >>> from hanbao.agents.model_factory import create_model_and_formatter
...
def _normalize_messages_for_formatter(
    ...
    if getattr(formatter_instance, "_hanbao_force_strip_media", False):
...
def _create_formatter_instance(
    ...
    Returns:
        ...
        the model's native one, plus hanbao extensions for media
