# -*- coding: utf-8 -*-
"""Hanbao Agent - Main agent implementation.

This module provides the main HanbaoAgent class built on ReActAgent,
...
# [hanbao modification] Coding mode removed.
...
class HanbaoAgent(Agent):
    """Hanbao Agent with integrated tools, skills, and memory management.
    ...
    def __init__(
        ...
        *,
        ...
        # Bypass agentscope's built-in permission engine — hanbao uses
    ...
    def load_state_dict(self, state_dict: dict, strict: bool = True) -> None:
        ...
        if isinstance(memory_raw, dict):
            from hanbao.app.chats.utils import parse_legacy_memory_state
    ...
    def _set_formatter_media_strip(self, enabled: bool) -> None:
        ...
        if formatter is None:
            return
        setattr(formatter, "_hanbao_force_strip_media", enabled)
    ...
    def _is_bad_request_or_media_error(exc: Exception) -> bool:
        ...
        if HanbaoAgent._is_content_safety_error(exc):
            return False
