...
ACP_CODING_PROJECT_META_KEY = "hanbao.coding_project_dir"
ACP_EPHEMERAL_META_KEY = "hanbao.ephemeral"
ACP_APPROVAL_EXPIRES_AT_META_KEY = "hanbao.approval_expires_at"
