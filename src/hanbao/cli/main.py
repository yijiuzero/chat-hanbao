...
class LazyGroup(click.Group):
    ...
    def parse_args(self, ctx, args):
        """Treat ``hanbao .`` as bare TUI launch with a project dir."""
        args = list(args)
...
def _looks_like_project_path(value: str) -> bool:
    """Return True for path-like CLI tokens intended for ``hanbao`` TUI."""
...
@click.group(
    ...
    lazy_subcommands={
        "acp": ("hanbao.cli.acp_cmd", "acp_cmd", ".acp_cmd"),
        "app": ("hanbao.cli.app_cmd", "app_cmd", ".app_cmd"),
        "channels": (
            "hanbao.cli.channels_cmd",
            "channels_group",
            ".channels_cmd",
        ),
        "channel": (
        ...
        "daemon": ("hanbao.cli.daemon_cmd", "daemon_group", ".daemon_cmd"),
        "chats": ("hanbao.cli.chats_cmd", "chats_group", ".chats_cmd"),
        "chat": ("hanbao.cli.chats_cmd", "chats_group", ".chats_cmd"),
        "clean": ("hanbao.cli.clean_cmd", "clean_cmd", ".clean_cmd"),
        "cron": ("hanbao.cli.cron_cmd", "cron_group", ".cron_cmd"),
        "env": ("hanbao.cli.env_cmd", "env_group", ".env_cmd"),
        "init": ("hanbao.cli.init_cmd", "init_cmd", ".init_cmd"),
        "models": (
            "hanbao.cli.providers_cmd",
            "models_group",
            ".providers_cmd",
        ),
        "skills": ("hanbao.cli.skills_cmd", "skills_group", ".skills_cmd"),
        "tui": ("hanbao.cli.tui.launch", "tui_cmd", ".tui.launch"),
        "uninstall": (
            "hanbao.cli.uninstall_cmd",
            "uninstall_cmd",
            ".uninstall_cmd",
        ),
        "desktop": ("hanbao.cli.desktop_cmd", "desktop_cmd", ".desktop_cmd"),
        "update": ("hanbao.cli.update_cmd", "update_cmd", ".update_cmd"),
        "shutdown": (
            "hanbao.cli.shutdown_cmd",
            "shutdown_cmd",
            ".shutdown_cmd",
        ),
        "auth": ("hanbao.cli.auth_cmd", "auth_group", ".auth_cmd"),
        "agents": ("hanbao.cli.agents_cmd", "agents_group", ".agents_cmd"),
        "agent": ("hanbao.cli.agents_cmd", "agents_group", ".agents_cmd"),
        "plugin": (
            "hanbao.cli.plugin_commands",
            "plugin",
            ".plugin_commands",
        ),
        "task": ("hanbao.cli.task_cmd", "task_cmd", ".task_cmd"),
        "doctor": ("hanbao.cli.doctor_cmd", "doctor_cmd", ".doctor_cmd"),
        "auto": ("hanbao.cli.auto", "auto_group", ".auto"),
    },
)
# [hanbao modification] Brand display name: Hanbao → hanbao
@click.version_option(version=__version__, prog_name="hanbao")
...
def cli(ctx: click.Context, host: str | None, port: int | None) -> None:
    ...
    # Bare ``hanbao`` (no subcommand) opens the interactive terminal chat UI.
