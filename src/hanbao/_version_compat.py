# -*- coding: utf-8 -*-
"""Plugin–Hanbao version compatibility check.
...
def check_plugin_version_compat(
    ...
    """Check whether a plugin is compatible with the running Hanbao.
    ...
    if current < min_v or current >= max_v:
        msg = f"requires Hanbao >={min_v}, <{max_v}, current is {current}"
        return False, msg
    return True, ""
