# -*- coding: utf-8 -*-
"""HanbaoLocalWorkspace — routes tool management to ToolRegistry.

Subclasses AgentScope's :class:`LocalWorkspace` so that
:meth:`list_tools` returns Hanbao's own tools (managed by
...
class HanbaoLocalWorkspace(AgentScopeLocalWorkspace):
    ...
    async def list_tools(  # type: ignore[override]
        ...
        *,
        ...
        """Return Hanbao tools, replacing AgentScope built-ins.
