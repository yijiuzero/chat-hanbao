...
# [hanbao modification] Memory panel, channel health, local knowledge base
# and fnOS integration routers (stage 6.am).
from .memory_admin import router as memory_admin_router
from .channel_status import router as channel_status_router
...
router.include_router(channel_status_router)
