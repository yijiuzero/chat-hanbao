# -*- coding: utf-8 -*-
"""Hanbao application approval gate for Driver policy."""
...
class HanbaoDriverApprovalGate:
    """Bridge Driver policy approval requests into Hanbao approval service."""

    async def request_approval(
        self,
        context: DriverInvocationContext,
    ) -> None:
        # Reuse Hanbao's approval Future flow: this coroutine pauses until
