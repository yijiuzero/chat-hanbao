# -*- coding: utf-8 -*-
"""
MatrixChannel: Hanbao BaseChannel implementation for Matrix (via matrix-nio).
...
logger = logging.getLogger("hanbao.channels.matrix")
...
# Known Hanbao slash commands — used to decide whether to strip
# @mention prefix
...
class MatrixChannel(BaseChannel):
    """Hanbao channel that connects to a Matrix homeserver via matrix-nio."""
    ...
    def from_config(
        ...
        return cls(
            ...
            device_name=raw.get("device_name", "hanbao-worker"),
    ...
    async def _on_room_event(
        ...
        # Skip history prepend for slash commands — Hanbao's command parser
    ...
    def build_agent_request_from_native(self, native_payload: Any) -> Any:
        ...
        # in the same room share one session (Hanbao keys session state on
