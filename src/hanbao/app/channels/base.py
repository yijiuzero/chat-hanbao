...
class BaseChannel(ABC):
    ...
    def _strip_event_headlines(event: Any, fallback: str) -> str:
        ...
        """
        from hanbao.agents.context.scroll.serialize import strip_headline
    ...
    def build_agent_request_from_user_content(
        ...
        Uses :mod:`hanbao.schemas` Message / Content types directly — no
    ...
    def _clear_session_turn_usage(session_id: str) -> None:
        ...
        mod = importlib.import_module("hanbao.token_usage.model_wrapper")
        ...
        *,
        ...
        try:
            ...
            turn_usage = importlib.import_module(
                "hanbao.token_usage.turn_usage",
            )
            token_usage = importlib.import_module("hanbao.token_usage")
    ...
    async def send_approval_notification(
        ...
        *,
        ...
        back to plain text.
        """
        from hanbao.schemas import AgentRequest, Event
