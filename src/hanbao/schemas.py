# -*- coding: utf-8 -*-
"""Hanbao streaming envelope schema.
...
hanbao's own envelope protocol — independent of agentscope's internal
event types.
"""
...
# ---------------------------------------------------------------------------
# Message envelope.
# hanbao's runner constructs an empty ``Message`` then calls
...
# These are constructed by hanbao rather than parsed from external input
