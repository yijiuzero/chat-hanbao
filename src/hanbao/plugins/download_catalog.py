...
def _is_entry_compatible(entry: dict[str, Any]) -> bool:
    """Return True when a CDN index entry supports the running Hanbao.

    Checks the structured ``hanbao_version`` field first, then falls
    ...
    manifest_data: dict[str, Any] = {
        "id": plugin_id,
        "version": version,
        "hanbao_version": version_constraint,
    }
