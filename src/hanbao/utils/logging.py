...
_LOG_BACKUP_COUNT = 3
_LOG_MAX_SIZE_ENV = "HANBAO_LOG_MAX_SIZE"
_LOG_BACKUP_COUNT_ENV = "HANBAO_LOG_MAX_BACKUPS"
...
def _attach_logger_file_handler(
    ...
    *,
    ...
    (stderr / journald) while also being written to ``hanbao.log``.
    """
...
def add_project_file_handler(log_path: Path) -> None:
    ...
    override these with HANBAO_LOG_MAX_SIZE and HANBAO_LOG_MAX_BACKUPS.
