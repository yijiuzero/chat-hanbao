# Hanbao Agent Team Practice Guide

This guide introduces how to build multi-agent collaborative teams using Hanbao + AgentTeams, achieving the capability leap from single Agent to Agent Team.
...
### Hanbao Team Solution

Hanbao Team provides a complete multi-Agent orchestration and collaboration solution by combining **Hanbao** + **[AgentTeams](https://hiclaw.io/)**:

- **Hanbao Team Leader**: Built on Hanbao, serves as team coordinator, responsible for task decomposition, work allocation, and result aggregation
- **Hanbao Workers**: Built on Hanbao, serve as task executors, focusing on domain-specific work, receiving Leader instructions and returning results
...
- [Hanbao Quick Start](./quickstart)
- [Hanbao Multi-Agent](./multi-agent)
- [Hanbao Skills](./skills)
...
Hanbao Agent Team, through the combination of Hanbao and AgentTeams, provides powerful multi-agent collaboration capabilities for individual developers and small teams. Through proper team design and task allocation, work efficiency can be significantly improved, achieving a "one-person team."
