...
const ROW_DIRECTIONS = [
  "hanbao-channels-marquee-left",
  "hanbao-channels-marquee-right",
  "hanbao-channels-marquee-left",
] as const;
  ...
  return (
    <>
      <motion.section
        ...
        aria-labelledby="hanbao-contributors-heading"
      >
        <div className="mx-auto max-w-7xl text-center">
          <motion.h2
            id="hanbao-contributors-heading"
        ...
        <div className="mx-auto max-w-7xl text-center">
          <div
            className="pointer-events-none relative left-1/2 mt-10 h-px w-screen -translate-x-1/2 animate-[hanbao-dash-move-right_1s_linear_infinite]"
            style={{
              background:
