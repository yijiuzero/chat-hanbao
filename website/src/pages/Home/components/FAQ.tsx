...
export function FAQ() {
            ...
            <>
              ...
              <ul className="mt-2 list-disc space-y-1 pl-5">
                ...
                <li>
                  ...
                  <code>pip install --upgrade hanbao</code>
                </li>
          ...
          answer: (
            <>
              <p>
                ...
                <code>hanbao init --defaults</code>
              </p>
              <p>
                {t("homeFaq.quickStart.initialize.p2")} <code>hanbao app</code>
              </p>
              <p className="mt-2">
          ...
          answer: (
            <>
              ...
              <p className="mt-2">
                ...
                <code>hanbao models</code> {t("homeFaq.features.models.p4Mid")}{" "}
                <Link
                  to="/docs/cli#hanbao-models"
                  className="text-(--color-primary) no-underline transition hover:brightness-110"
                >
            ...
            <>
              ...
              <ol className="mt-2 list-decimal space-y-1 pl-5">
                ...
                <li>
                  ...
                  <code>hanbao_query_error_qzbx1mv1.json</code>
  ...
  return (
    <motion.section
      ...
      aria-labelledby="hanbao-faq-heading"
    >
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-8 md:grid-cols-[40%_60%] md:gap-12">
          <motion.div variants={itemVariants}>
            <h2 id="hanbao-faq-heading" className={sectionStyles.title}>
              {t("homeFaq.title")}
            </h2>
            <p
